                    ...
                    <div className="row">
                        <div className="col-12 col-lg-6 mb-4 mb-lg-0">
                            <div className="img-head">
                                <img src={wildlife} alt="buffaloes and elephant walking alongside river"/>
                            </div>
                        </div>
                        <div className="col-12 col-lg-6">
                            ...
                            <p className="text-para">
                                Charity Hub is a platform that allows to connect with the largest and most effective charities around the world. We help people connect with different organizations.
